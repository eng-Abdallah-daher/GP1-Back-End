...
class EmailService {
 ...
 doc.moveTo(50, 100).lineTo(550, 100).stroke("#000080");
 ...
 doc
   .fontSize(10)
   .fillColor("gray")
   .text("Thank you for choosing our service!", 50, 700, { align: "center" })
   .text("For any inquiries, contact abdallahdaher205@gmail.com", 50, 715, {
     align: "center",
   });

 doc.moveTo(50, 680).lineTo(550, 680).stroke("#000080");
 ...
 doc.end();
      ...
      const mailOptions = {
        from: '"Your Shop" <s12116027@stu.najah.edu>',
        to: recipientEmail,
        subject: "Service Fee Invoice",
        text: `Hello ${userName},\n\nPlease find attached the invoice for your service fee of $${cost}.\n\nThank you!`,
        attachments: [
          {
